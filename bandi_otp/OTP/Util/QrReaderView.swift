...
class QrReaderView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.initialSetupView(cameraOption:"back")
    }
    ...
    func initialSetupView(cameraOption: String) {
        ...
        guard let videoCaptureDevice = AVCaptureDevice.default(.builtInWideAngleCamera, for: .video, position: cameraPosition) else {
            return
        }
